...
func NewWithConfig(ctx context.Context, config *Config) (*Pool, error) { return &Pool{}, nil }
...
func (p *Pool) Exec(ctx context.Context, sql string, args ...any) (CommandTag, error) { return CommandTag{}, nil }
func (p *Pool) Begin(ctx context.Context) (Tx, error) { return Tx{}, nil }

type Row struct{}
func (r Row) Scan(dest ...any) error { return pgx.ErrNoRows }

type CommandTag struct{}
type Rows struct{}
func (r Rows) Close() {}
func (r Rows) Next() bool { return false }
func (r Rows) Scan(dest ...any) error { return pgx.ErrNoRows }
